...
int main()
{
    ...
    //done: 6. uncomment one by one and render the following worlds
    ...
    //done: 1. set your own path for output image
    std::string result_ppm_path = "/Users/milladbahrami/Desktop/bahram23GC3A4/screenshots/result.ppm";
